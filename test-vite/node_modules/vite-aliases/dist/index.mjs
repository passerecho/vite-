...
async function writeJSON(path, data, process2) {
  ...
  const state = process2 === "add" || process2 === "normal" ? "created" : "updated";
  try {
...
// src/fs/config.ts
async function writeConfig(gen, process2 = "normal") {
  ...
  try {
    ...
    if (existsSync(file)) {
      ...
      if (json.compilerOptions) {
        ...
        if (process2 === "remove") {
          paths = Object.fromEntries(Object.entries(paths).filter((p) => {
...
var Generator = class {
  constructor(servermode, options) {
    ...
    this.fullPath = slash(resolve2(this.options.root, this.options.dir));
    if (servermode === "serve") {
      this.observe();
    }
  }
